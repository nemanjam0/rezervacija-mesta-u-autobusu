...
const { Autobus, Destinacija, Polazak, Prevoznik, PrivremenoRezervisanoSediste, RedVoznje, Rezervacija, RezervisanoSediste } = sequelize.models;
const QueryTypes = Sequelize.QueryTypes;
export const prikaziZauzetaSediste = async (polazak_id, pocetna_destinacija_id, krajnja_destinacija_id, specificno_sediste_red = null, specificno_sediste_mesto_u_redu = null) => {
...
export const kreirajRezervaciju = async (polazak_id, korisnik_id, platio, pocetna_destinacija_id, krajnja_destinacija_id, sedista, cena_po_karti, transakcija = null) => {
...
export const privremenoRezervisi = async (polazak_id, korisnik_id, pocetna_destinacija_id, krajnja_destinacija_id, red, mesto_u_redu, predlog_isteka) => {
...
export const obrisiPrivremeno = async (id, korisnik_id) => {
...
export const prikaziZaKorisnika = async (korisnik_id) => {
...
export const nadjiRezervacijuSaSedistima = async (rezervacija_id, specificno_sediste_id = null) => {
  var uslov = {};
  var sediste_uslov = {};
...
export const statistika = async (korisnik_id, pocetni_datum, krajnji_datum) => {
  let upit = `SELECT
