...
module.exports.kreirajPolaskeZaRedVoznje=(red_voznje_id,autobus_id,vreme_polaska,rok_vazenja,ponedeljak,utorak,sreda,cetvrtak,petak,subota,nedelja)=>//kreira sve polaske za odredjeni red voznje
{
    var dani=[ponedeljak,utorak,sreda,cetvrtak,petak,subota,nedelja];
    var danasnji_datum=moment().endOf('day');
